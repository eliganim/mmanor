  ...
  return (
    <Text>
      ...
      <p>
        ...
        תכנית לימודי "בריאות נפשית בזקנה" מאוניברסיטת ברקלי בקליפורניה, במסגרתה צברתי ידע ומומחיות בתחומים נפוצים בשלב
        זה של החיים, בהם: מצבי בריאות יחודיים לזקנה, ירידה קוגנטיבית ודמנציה, התמודדות עם אבל ואבדן, עבודה עם משפחות
        ושלבי טיפול יחודיים בסוף החיים.
      </p>
      <p>
