...
const Services = () => {
  ...
  if (service) {
    switch (service) {
      case 'rights':
        content = (
          <>
            <Heading as='u'>מיצוי זכויות לגיל השלישי</Heading>
            <p>
      ...
      case 'legal':
        content = (
          <>
            <Heading as='u'>תכנון משפטי – יפוי כח רפואי מתמשך/החלטות לגבי סוף החיים</Heading>
            <p>
      ...
      case 'logotherapy':
        content = (
          <>
            <Heading as='u'>לוגותרפיה - יצירת משמעות בגיל השלישי</Heading>
      ...
      case 'homeaid':
        content = (
          <>
            <Heading as='u'>סיוע בשילוב עזרה ביתית</Heading>
            <p>
      ...
      case 'caregivers':
        content = (
          <>
            <Heading as='u'>תמיכה ויעוץ לבני משפחה/מטפלים עיקריים</Heading>
      ...
      case 'nursery':
        content = (
          <>
            <Heading as='u'>מעבר לבית אבות/דיור מוגן</Heading>
            <p>
      ...
      case 'dementia':
        content = (
          <>
            <Heading as='u'>התמודדות עם ירידה קוגנטיבית ודמנציה במשפחה</Heading>
            <p>
  ...
  return (
    <>
      {content}
      <br />
      {service ? <Heading as='u'>תחומי שירות נוספים</Heading> : <Heading as='u'>תחומי השירות</Heading>}
      <List styleType='' px='20px'>
        <ListItem>
